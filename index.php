...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">Uninett | Employee Leave Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="https://sites.google.com/view/uninett-technology/home">UninettTechnology </a></p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome To Uninett ELMS</h4></div>
